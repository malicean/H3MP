...
namespace H3MP.Serialization
{
	public static class TruncatedSerializers
	{
		...
		public static ISerializer<int> UShortAsInt { get; } = new ConverterSerializer<int, ushort>(PrimitiveSerializers.UShort, Converters.UShortInt, Converters.UShortInt);
		...
		public static ISerializer<float> ShortAsFloat(float min, float max, ISerializer<short> serializer)
		{
		...
		public static ISerializer<float> UShortAsFloat(float max, ISerializer<ushort> serializer)
		{
