...
namespace H3MP.Utils
{
	...
	{
		public static Option<T> NullToOption<T>(this T @this) where T : class
		{
			return @this is null ? Option.None<T>() : Option.Some(@this);
		}

		public static Option<T> NullToOption<T>(this T? @this) where T : struct
		{
			return @this.HasValue ? Option.Some(@this.Value) : Option.None<T>();
		}
